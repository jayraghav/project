  ...
  //  private int selectorColor = Color.parseColor("#116b2b66");
    ...
    private void initView(Context context) {
     ...
     /*   view1 =  findViewById(R.id.view1);
        ...
        selector.setBackgroundColor(Color.parseColor("#4476A1E6"));
    ...
    public void onWindowFocusChanged(boolean hasWindowFocus) {
        ...
        if (!setListView && adapter != null) {
           ...
           /* if (view1.getLayoutParams() instanceof MarginLayoutParams) {
                MarginLayoutParams p = (MarginLayoutParams) view1.getLayoutParams();
                //p.height = cellHeight;
              //  p.height = 20;
                p.setMargins(30, cellHeight * middleCell, 30, 0);
                view1.requestLayout();
            }
            if (view2.getLayoutParams() instanceof MarginLayoutParams) {
                MarginLayoutParams p = (MarginLayoutParams) view2.getLayoutParams();
                //p.height = cellHeight;
                //  p.height = 20;
                p.setMargins(30, (cellHeight+120) * middleCell, 30, 0);
                view2.requestLayout();
            }
