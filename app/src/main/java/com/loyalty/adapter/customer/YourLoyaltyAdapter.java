...
public class YourLoyaltyAdapter extends RecyclerView.Adapter<YourLoyaltyAdapter.ViewHolder> {
    private Context mContext;
    //    private List<LoyaltyHistory> loyaltyList;
    private List<YourLoyaltyDetails> loyaltyList;
    private OnHistoryListener onHistoryListener;
    public YourLoyaltyAdapter(Context context, List<YourLoyaltyDetails> loyaltyList, OnHistoryListener onHistoryListener) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        double loyaltyPoints=Double.parseDouble(loyaltyList.get(position).points);
        int point=(int)loyaltyPoints;
        int oneStarPoint = Integer.parseInt(loyaltyList.get(position).oneStarPoints);
        int twostarPoint = Integer.parseInt(loyaltyList.get(position).twoStarPoints);
        int threestarPoint = Integer.parseInt(loyaltyList.get(position).threeStarPoints);
